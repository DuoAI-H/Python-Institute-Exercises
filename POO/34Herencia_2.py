#Nota: la composición es el proceso de componer un objeto
#usando otros objetos diferentes.
#La composición puede ser mejor alternativa que la herencia multiple.
import time
